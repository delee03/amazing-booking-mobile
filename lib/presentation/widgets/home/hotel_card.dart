...
import '../../screens/roomdetail/room_detail_screen.dart';
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => RoomDetailScreen(roomId: hotel.id),
            ),
          );
        },
        child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Image.network(
                    hotel.avatar,
                    fit: BoxFit.cover, // Chỉnh kích thước hình ảnh để phủ đầy khung
                  ),
                ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            hotel.averageStar.toStringAsFixed(1), // Hiển thị số sao trung bình với 1 chữ số thập phân
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 20,
                ...
                const SizedBox(height: 5),
                Padding(
                  padding: const EdgeInsets.fromLTRB(18.0, 0, 18.0, 16.0), // Mở rộng padding cho mô tả
                  child: Text(
                    hotel.description,
                    style: const TextStyle(
                      color: Colors.grey,
